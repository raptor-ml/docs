...
After the Feature Definitions have been deployed to your cluster, Natun Operator automatically discovers them and uses the relevant [Builder](./how-does-natun-work/feature-builders) to configure the resources needed for the Feature. Such resources include data-connectors to external sources, storage resources, and compute resources.

Finally, after the Features have been deployed, you can server these features to the model or utilize the [FeatureSet](./how-does-natun-work/feature-sets) to prepare a ready-to-use data-set.
